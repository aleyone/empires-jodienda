/* api/jobs/wiki-parser.js
   Parser de wikitext compartido entre hero-lookup y wiki-check job
*/
...
function parseHeroWikitextForJob(wikitext, heroName) {
  const firstBlock = extractFirstHeroBlock(wikitext);
  return parseHeroWikitext(firstBlock, heroName);
}

module.exports = { parseHeroWikitextForJob };
